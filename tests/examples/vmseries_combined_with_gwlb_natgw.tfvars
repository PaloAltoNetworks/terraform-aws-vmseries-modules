...
# Security VPC
security_vpc_name = "terratest-security-vpc"
...
gwlb_name                       = "terratest-security-gwlb"
gwlb_endpoint_set_outbound_name = "outbound-gwlb-endpoint"

### NAT gateway
nat_gateway_names = {
  "us-east-1a" = "terratest-natgwa"
  "us-east-1b" = "terratest-natgwb"
}
# VM-Series
vmseries_version = "10.2.2"
ssh_key_name     = "terratest-ssh-key"
firewalls = {
