...
This module creates a set of VPC Endpoints over a range of (one or more) Availability Zones.
All the VPC Endpoints transfer the traffic to the same Gateway Load Balancer (GWLB).
