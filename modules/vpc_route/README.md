...
|------|-------------|------|---------|:--------:|
| <a name="input_cidr_type"></a> [cidr\_type](#input\_cidr\_type) | Type of `to_cidr`, "ipv4", "ipv6" or "mpl". | `string` | `"ipv4"` | no |
| <a name="input_managed_prefix_list"></a> [managed\_prefix\_list](#input\_managed\_prefix\_list) | Managed prefix list, which needs to created and set as a destination in route | <pre>object({<br>    name        = string<br>    max_entries = number<br>    entries = map(object({<br>      cidr        = string<br>      description = string<br>    }))<br>  })</pre> | `null` | no |
| <a name="input_managed_prefix_list_id"></a> [managed\_prefix\_list\_id](#input\_managed\_prefix\_list\_id) | ID of managed prefix list, which is going to best as destination in route | `string` | `null` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_destination_cidr_block"></a> [destination\_cidr\_block](#output\_destination\_cidr\_block) | n/a |
| <a name="output_destination_managed_prefix_list_entries"></a> [destination\_managed\_prefix\_list\_entries](#output\_destination\_managed\_prefix\_list\_entries) | n/a |
| <a name="output_destination_managed_prefix_list_id"></a> [destination\_managed\_prefix\_list\_id](#output\_destination\_managed\_prefix\_list\_id) | n/a |
