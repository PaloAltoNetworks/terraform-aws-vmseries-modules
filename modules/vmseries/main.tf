...
resource "aws_instance" "this" {
  ...
  root_block_device {
    ...
    kms_key_id            = var.root_block_device_encrypted == false ? null : var.root_block_device_encryption_kms_key_arn != null ? var.root_block_device_encryption_kms_key_arn : data.aws_kms_key.current.arn
