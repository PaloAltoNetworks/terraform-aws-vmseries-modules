...
| Name | Description |
|------|-------------|
| <a name="output_app_lb_fqdn"></a> [app\_lb\_fqdn](#output\_app\_lb\_fqdn) | Fully Qualified Domain Name of the internal Network Load Balancer placed in front of the Application VMs. |
...
| <a name="output_public_lb_fqdn"></a> [public\_lb\_fqdn](#output\_public\_lb\_fqdn) | Fully Qualified Domain Names for Load Balancer in front of the Firewalls. |
