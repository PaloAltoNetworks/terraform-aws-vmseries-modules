...
| <a name="input_loadbalancers"></a> [loadbalancers](#input\_loadbalancers) | ## ALB | <pre>object({<br>    application_lb = object({<br>      name            = string<br>      rules           = any<br>      vms             = list(string)<br>      vpc             = string<br>      subnet_sets     = string<br>      security_groups = string<br>    })<br>  })</pre> | n/a | yes |
